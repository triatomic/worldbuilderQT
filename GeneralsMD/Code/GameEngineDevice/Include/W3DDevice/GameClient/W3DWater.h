...
protected:
	...
	Real				m_iBumpFrameAccum;	///<fractional bump-frame accumulator (wall-clock paced)
	Int					m_lastPhaseUpdateTime;	///<timeGetTime() of last update() phase advance; 0 = uninitialized
